...
import com.fsck.ptl.mail.filter.FixedLengthInputStream;
...
import static com.fsck.ptl.mail.K9MailLib.PUSH_WAKE_LOCK_TIMEOUT;
...
public class ImapStore extends RemoteStore {
     ...
     *
     * @see com.fsck.ptl.mail.store.StoreConfig#getStoreUri()
