...
import com.fsck.ptl.mail.filter.CountingOutputStream;
...
public abstract class Message implements Part, CompositeBody {
     ...
     * {@link com.fsck.ptl.activity.MessageView.Listener#loadMessageForViewHeadersAvailable(com.fsck.ptl.Account, String, String, Message)}
