package com.fsck.ptl.mail.store;
...
import com.fsck.ptl.mail.ssl.DefaultTrustedSocketFactory;
import com.fsck.ptl.mail.ssl.TrustedSocketFactory;
import com.fsck.ptl.mail.store.imap.ImapStore;
...
public abstract class RemoteStore extends Store {
     ...
     *
     * @param storeConfig {@link com.fsck.ptl.mail.store.StoreConfig} instance that is used to get the remote mail store instance.
     */
    ...
    /**
     * Decodes the contents of store-specific URIs and puts them into a {@link com.fsck.ptl.mail.ServerSettings}
     * object.
     *
     * @param uri
     *         the store-specific URI to decode
     *
     * @return A {@link com.fsck.ptl.mail.ServerSettings} object holding the settings contained in the URI.
     *
     * @see com.fsck.ptl.mail.store.imap.ImapStore#decodeUri(String)
     * @see com.fsck.ptl.mail.store.pop3.Pop3Store#decodeUri(String)
     * @see com.fsck.ptl.mail.store.webdav.WebDavStore#decodeUri(String)
     */
    ...
    /**
     * Creates a store URI from the information supplied in the {@link com.fsck.ptl.mail.ServerSettings} object.
     *
     * @param server
     *         The {@link com.fsck.ptl.mail.ServerSettings} object that holds the server settings.
     *
     * @return A store URI that holds the same information as the {@code server} parameter.
     *
     * @see com.fsck.ptl.mail.store.imap.ImapStore#createUri(com.fsck.ptl.mail.ServerSettings)
     * @see com.fsck.ptl.mail.store.pop3.Pop3Store#createUri(com.fsck.ptl.mail.ServerSettings)
     * @see com.fsck.ptl.mail.store.webdav.WebDavStore#createUri(com.fsck.ptl.mail.ServerSettings)
     */
