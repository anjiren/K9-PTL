...
import com.fsck.ptl.Account.SortType;
import com.fsck.ptl.FontSizes;
import com.fsck.ptl.K9;
import com.fsck.ptl.Preferences;
import com.fsck.ptl.R;
import com.fsck.ptl.activity.ActivityListener;
import com.fsck.ptl.activity.ChooseFolder;
import com.fsck.ptl.activity.FolderInfoHolder;
import com.fsck.ptl.activity.MessageReference;
import com.fsck.ptl.activity.misc.ContactPictureLoader;
import com.fsck.ptl.cache.EmailProviderCache;
import com.fsck.ptl.controller.MessagingController;
import com.fsck.ptl.fragment.ConfirmationDialogFragment.ConfirmationDialogFragmentListener;
import com.fsck.ptl.helper.ContactPicture;
import com.fsck.ptl.helper.MergeCursorWithUniqueId;
import com.fsck.ptl.helper.MessageHelper;
...
import com.fsck.ptl.mailstore.LocalFolder;
import com.fsck.ptl.mailstore.LocalMessage;
import com.fsck.ptl.mailstore.LocalStore;
import com.fsck.ptl.provider.EmailProvider;
import com.fsck.ptl.provider.EmailProvider.MessageColumns;
import com.fsck.ptl.provider.EmailProvider.SpecialColumns;
import com.fsck.ptl.provider.EmailProvider.ThreadColumns;
import com.fsck.ptl.search.ConditionsTreeNode;
import com.fsck.ptl.search.LocalSearch;
import com.fsck.ptl.search.SearchSpecification;
import com.fsck.ptl.search.SearchSpecification.SearchCondition;
import com.fsck.ptl.search.SearchSpecification.Searchfield;
import com.fsck.ptl.search.SqlQueryBuilder;

import com.handmark.pulltorefresh.library.ICallback;
import com.handmark.pulltorefresh.library.Leitner;
import com.handmark.pulltorefresh.library.LeitnerUser;
import com.handmark.pulltorefresh.library.PTLLogger;
...
public class MessageListFragment extends Fragment implements OnItemClickListener,
    ...
    Handler delayedOnCompleteHandler = new Handler();
    Runnable onRefreshCompleteRunnable = new Runnable() {
        public void run() {
    ...
    // TODO: Display exercise delay/handler.
    ...
    private void progress(final boolean progress) {
        ...
        if (mPullToRefreshView != null && !progress) {
            // TODO: Let exercise show for 5 more seconds before calling onRefreshComplete, but
            // TODO: get rid of loading icon.
            delayedOnCompleteHandler.postDelayed(onRefreshCompleteRunnable, PTL_WAIT);
            Log.e("postDelayed", delayedOnCompleteHandler.toString() + onRefreshCompleteRunnable);
        }
    }

    @Override
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Log.e("ITEM CLICKED", "Removing handler" + delayedOnCompleteHandler+" callback of: "+onRefreshCompleteRunnable);
        delayedOnCompleteHandler.removeCallbacks(onRefreshCompleteRunnable);
        delayedOnCompleteHandler.post(onRefreshCompleteRunnable);
        PTLLogger.logInterruptEmailClick();
        if (view == mFooterView) {
    ...
    private class MainCallback implements ICallback {
        @Override
        public void callback(String string) {
        }
    }

    public ICallback leitnerInitCallback = new MainCallback();
    ...
    public void initializeFirebase() {
        ...
        if (authData != null) {
            ...
            initializeUserFirebase(userId);
        } else {
            rootRef.authWithPassword(mAccount.getEmail(), "waitpeople",
                    new Firebase.AuthResultHandler() {
                        @Override
                        public void onAuthenticated(AuthData authData) {
                            // Authentication successful.
                            Log.i("AUTH YAY", "FIREBASE AUTHENTICATION SUCCESS!");
                            String userId = rootRef.getAuth().getUid();
                            initializeUserFirebase(userId);
                        }

                        @Override
                        public void onAuthenticationError(FirebaseError error) {
                            Log.e("AUTH NAY", "Authentication error - what happened?");
                            switch (error.getCode()) {
                                case FirebaseError.USER_DOES_NOT_EXIST:
                                    Log.e("AUTH NAY", "User does not exist...");
                                case FirebaseError.INVALID_PASSWORD:
                                    Log.e("AUTH NAY", "Wrong password?");
                                    break;
                                default:
                                    Log.e("AUTH NAY", "What.");
                                    break;
    ...
    public void initializeUserFirebase(final String userId) {
                ...
                if (snapshot.exists()) {
                    ...
                    userRef.runTransaction(new Transaction.Handler() {
                        ...
                        public Transaction.Result doTransaction(MutableData currentData) {
                            currentData.child("floor").setValue(0);
                            currentData.child("email").setValue(mAccount.getEmail());
                            currentData.child("language").setValue("french");
    ...
    private void initializePullToRefresh(LayoutInflater inflater, View layout) {
        ...
        mPullToRefreshView.setOnRefreshCompleteHandler(delayedOnCompleteHandler,
                onRefreshCompleteRunnable);

        // Set up view for exercise mode.
    ...
    class MessageListActivityListener extends ActivityListener {
        ...
        int totalMessagesInMailbox, int numNewMessages) {
            ...
            if (updateForMe(account, folder)) {
                ...
                mPullToRefreshView.hideLoading();
