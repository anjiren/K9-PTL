...
import com.fsck.ptl.activity.MessageCompose;
import com.fsck.ptl.activity.UpgradeDatabases;
...
import com.fsck.ptl.mail.internet.BinaryTempFileBody;
import com.fsck.ptl.mailstore.LocalStore;
import com.fsck.ptl.provider.UnreadWidgetProvider;
import com.fsck.ptl.mail.ssl.LocalKeyStore;
import com.fsck.ptl.service.BootReceiver;
import com.fsck.ptl.service.MailService;
import com.fsck.ptl.service.ShutdownReceiver;
import com.fsck.ptl.service.StorageGoneReceiver;
...
public class K9 extends Application {
     ...
     * was called.
     * Afterwards calls to {@link #registerApplicationAware(com.fsck.ptl.K9.ApplicationAware)} will
     * immediately call {@link com.fsck.ptl.K9.ApplicationAware#initializeComponent(K9)} for the
     * supplied argument.
     */
     ...
     * {@link com.fsck.ptl.preferences.GlobalSettings}, too.
     *
